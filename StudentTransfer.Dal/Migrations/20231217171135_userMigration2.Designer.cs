...
namespace StudentTransfer.Dal.Migrations
{
    ...
    [Migration("20231217171135_userMigration2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentTransfer.Dal.Entities.Auth.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StudentTransfer.Dal.Entities.User.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("StudentTransfer.Dal.Entities.Auth.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("StudentTransfer.Dal.Entities.User.AppUser", null)
                        .WithMany()
